...
<div class="layui-layout layui-layout-admin" >
    ...
    <div class="layui-row ">
        ...
        <div id='twoMenu' class="layui-col-xs10" style="display: none; margin-top: 40px;margin: 10px 20px;width: 88%">
            <div>
                <ul style="margin-top: 10%;width: 80%;left: 40%;margin: 37px auto">
                    ...
                    <li style=" margin: 0 auto;margin-right: 10%"><button style="float:right;color:#FFFFFF;height: 100px;display:block;margin:0 auto;margin-top:0px;width:250px;background-color:#71B863;border-radius:32px;text-align: center;line-height: 50px;font-size: 35px">设备电源</button></li>
                </ul>
            </div>
            <div>
        ...
        <div class="layui-col-xs1" align="right" style="height:100%;width: 9%;border-left: 1px solid #c2c2c2;">
            <div>
                <button id='colorType' onclick="beforShow()"  style="color:#FFFFFF;height: 80px;display:block;margin:0 auto;margin-top:0px;width:80px;background-color: #4472c4;border-radius:14px;text-align: center;line-height: 30px;font-size: 27px">
                    现场管理
                </button>
            </div>
            <div>
...
<script>
    ...
    function beforShow() {
        if(document.getElementById("colorType").style.backgroundColor !="rgb(68, 144, 191)"){
        alert("成功了")
            show();
        }
    }
